...
userRoutes.get('/users', auth_user_middleware_1.verifyUser, controller.getAllUser);
userRoutes.get('/users/:uuid', auth_user_middleware_1.verifyUser, controller.getUserByUUID);
userRoutes.post('/users', auth_user_middleware_1.verifyUser, controller.createUser);
